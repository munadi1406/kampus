<div class="card">
    ...
    <div class="card-body">
        ...
        <!-- <div class="col-md-12"> -->
        <a href="?page=add-dosen" class="btn btn-primary mb-2">Tambah Data</a>
        <a href="../dosen/print_dosen.php" target="_blank" class="btn btn-success mb-2">Cetak Data</a>
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                $query = mysqli_query($con, "SELECT * FROM dosen LIMIT $mulai, $limit");
                ?>
                <thead>
                    <tr>
                        <th>No</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-danger" href="?page=delete-dosen&id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a>
                            </td>
                        </tr>
                    <?php
                        $no++;
